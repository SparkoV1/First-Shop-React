...
function Cart({cart, handlerRemoveFromCart, handlerEmptyCart, handlerUpdateCartQty}) {
            ...
            <Grid container spacing={3}>
                {cart.line_items.map((item) => (
                    <Grid item xs={12} sm={4} key={item.id}>
                        <CartItem
                            item={item}
                            onUpdateCartQty={handlerUpdateCartQty}
                            onRemoveFromCart={handlerRemoveFromCart}/>
                    </Grid>
                ))}
            </Grid>
            <div className={classes.cardDetails}>
                ...
                <div>
                    <Button className={classes.emptyButton} size='large' type='button' variant='contained'
                            color='secondary' onClick={handlerEmptyCart}>Empty Cart</Button>
